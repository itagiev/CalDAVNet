...
{
    public static XDocument Propfind(IReadOnlyCollection<XName> props)
    {
    ...
    public static XDocument Propfind(IReadOnlyCollection<XName> propfinds, IReadOnlyCollection<XName> props)
    {
        var propfind = new XElement(XNames.Propfind,
            new XAttribute(XNamespace.Xmlns + Constants.DAV.Prefix, Constants.DAV.Namespace),
            new XAttribute(XNamespace.Xmlns + Constants.Server.Prefix, Constants.Server.Namespace),
    ...
    public static XDocument CalendarMultiget(params string[] hrefs)
    ...
    public static XDocument Mkcalendar(string displayName, string supportedComponent, string? description = null,
        string? color = null)
    {
    ...
    public static XDocument PropertyUpdate(string? displayName = null, string? description = null,
        string? color = null)
    {
        var prop = new XElement(XNames.Prop);
